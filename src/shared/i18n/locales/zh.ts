...
export const zh = {
  ...
  players: {
    ...
    seatStart: {
      ...
      label: '这局谁在玩（{{n}} 人）',
      start: '就坐（{{n}} 人）',
      /** 人数不到工具要求的下限时，就坐按钮换这句并禁用 —— 限制落在选人这一步，不进开局页 */
      tooFew: '至少 {{n}} 人',
  ...
  games: {
    ...
    alias: {
      ...
      fakeArtist: '假艺术家 画画 纽约 Fake Artist',
      gloomhaven: '幽暗港 幽港 Gloomhaven GH',
    },
  },
  ...
  match: {
    ...
    share: {
      ...
      copyText: '复制文本',
      copied: '已复制',
      /** 跳转链接不是请求：没装 BGStats 的设备只是打开一个网页（见 [bgstats.ts](../../match/bgstats.ts)） */
      pushBgStats: '推送到 BGStats',
      /** 换形态时新图还没画完那一小会儿 */
      rendering: '正在生成…',
  ...
  dealRoles: {
    ...
    again: '重新洗牌再发',
    /** 重洗 = 刚才发出去的身份全部作废，所以要二次确认、且不占主按钮位 */
    againConfirm: '确认重洗（已发的身份作废）',
    stop: '结束发牌',
    stopConfirm: '确认结束',
    online: {
      start: '扫码发牌',
  ...
  tools: {
    codenames: {
      ...
      qrKey: '队长答案二维码',
      qrHint: '队长用手机扫码看答案 · 点任意处关闭',
      keyOnly: '仅队长查看',
      keyHint: '点牌面标记已翻',
      keyInvalid: '二维码无效或版本不一致',
      marked: '第{{n}}张翻出',
      markedBy: '第{{n}}回合{{team}}选中',
      team: {
        red: '红队',
        blue: '蓝队',
      },
    ...
    fakeArtist: {
      ...
      board: {
        ...
        undo: '撤销上一笔',
        finish: '结束作画',
        finishConfirm: '确认结束作画',
        done: '画完了，开始讨论吧',
        answer: '答案：{{word}}',
        reveal: '公布答案',
        again: '再来一局',
        againConfirm: '确认重开（清掉画作与题）',
        /** 定格亮答案后的底栏按钮，打开分享面板 */
        share: '分享',
      },
      share: {
    ...
    undercover: {
      ...
      /** 启动台的词库规模 */
      pairs: '内置 {{n}} 对词',
      /** 白板的提示语是他的内容行：非盲发局才给，盲发局他的牌就该是空的 */
      blankHint: '你没有词 —— 跟着大家描述，别露馅',
      /** 盲发开关的分区标签 */
      blindLabel: '变体',
      /** 盲发开关：开 = 卧底不知道自己是卧底 */
      blind: '卧底不知情',
      blindHint: '所有人的牌面只出词、不出身份；白板的牌是空的',
      roles: {
        set: '谁是卧底',
        role: {
          civilian: '平民',
    ...
    gloomhaven: {
      ...
      settle: '结算',
      newScenario: '新一场',
      confirmNewScenario: '确认重开',
      /** 回选人界面换角色/管理角色纸，竖屏控制栏只放得下两三个字 */
      switchSheet: '角色',
      openSheet: '角色纸',
      /** 临时模式的血上限定档（没绑角色纸时用） */
      tempMaxHp: '生命上限',
      ...
      createTitle: '选择职业',
      noSheets: '还没有角色纸。',
      /** IDB 被禁（隐私模式等）时角色纸整块关掉，临时模式照用 */
      unavailable: '这台设备禁用了本地数据库，角色纸功能不可用；可以直接用临时模式。',
      export: '导出备份',
      import: '导入备份',
      importFailed: '备份文件无法识别',
      removeSheet: '删除角色纸 {{name}}',
      maxLevel: '已满级',
      /** 经验转盘下的升级进度提示 */
      toNext: '再 {{n}} 升级',
      classes: {
        ...
        cragheart: '岩心',
        mindthief: '窃心者',
        /** 解锁职业/房规的兜底：血上限手动调，perk 对照实体角色纸勾 */
        custom: '自定义',
      },
      status: {
        bless: '祝福',
      ...
      editor: {
        ...
        items: '物品栏',
        addItem: '添加物品',
        itemPlaceholder: '物品编号或名称',
        equipped: '装备中',
        removeItem: '移除 {{name}}',
        notes: '备注',
      },
      /**
       * perk 文案。「滚动」= rolling（抽出不弃的额外修正牌）。
       * 行顺序与实体角色纸一致，勾选框数在 [classes.ts](../../../../tools/gloomhaven/classes.ts)
       */
      perks: {
        brute: {
          p01: '移除两张 -1 牌',
          p02: '将一张 -1 牌替换为一张 +1 牌',
          p03: '加入两张 +1 牌',
          p04: '加入一张 +3 牌',
          p05: '加入三张 滚动·推1 牌',
          p06: '加入两张 滚动·穿透3 牌',
          p07: '加入一张 滚动·眩晕 牌',
          p08: '加入一张 滚动·缴械 和一张 滚动·混乱 牌',
          p09: '加入一张 滚动·目标 牌',
          p10: '加入一张 +1·护盾1·自身 牌',
          p11: '无视物品负面效果，加入一张 +1 牌',
        },
        tinkerer: {
          p01: '移除两张 -1 牌',
          p02: '将一张 -2 牌替换为一张 +0 牌',
          p03: '加入两张 +1 牌',
          p04: '加入一张 +3 牌',
          p05: '加入两张 滚动·火焰 牌',
          p06: '加入三张 滚动·混乱 牌',
        ...
        spellweaver: {
          ...
          p08: '加入一张 +2·火焰 牌',
          p09: '加入一张 +2·寒冰 牌',
          p10: '加入一张 滚动·大地 和一张 滚动·风 牌',
          p11: '加入一张 滚动·光 和一张 滚动·暗 牌',
        },
        scoundrel: {
          p01: '移除两张 -1 牌',
          p02: '移除四张 +0 牌',
          p03: '将一张 -2 牌替换为一张 +0 牌',
          p04: '将一张 -1 牌替换为一张 +1 牌',
          p05: '将一张 +0 牌替换为一张 +2 牌',
          p06: '加入两张 滚动·+1 牌',
          p07: '加入两张 滚动·穿透3 牌',
          p08: '加入两张 滚动·中毒 牌',
          p09: '加入两张 滚动·混乱 牌',
        ...
        mindthief: {
          p01: '移除两张 -1 牌',
          p02: '移除四张 +0 牌',
          p03: '将两张 +1 牌替换为两张 +2 牌',
          p04: '将一张 -2 牌替换为一张 +0 牌',
          p05: '加入一张 +2·寒冰 牌',
          p06: '加入两张 滚动·+1 牌',
          p07: '加入三张 滚动·拉1 牌',
          p08: '加入三张 滚动·混乱 牌',
